'''
Concrete SettingModule class for stage 4 train/test setting.
'''

from local_code.base_class.setting import setting
from local_code.stage_4_code.Evaluate_Multiclass_Metrics import Evaluate_Multiclass_Metrics
...
class Setting_Train_Test_Split(setting):
    ...
    def load_run_save_evaluate(self):
        ...
        # vocab is built during load_file(); the Method needs it sized before run()
        if hasattr(self.dataset, 'vocab') and self.dataset.vocab is not None:
